...
const sections = [
  ...
  ['3. Eligible services and rates', 'Only services shown as active in the programme configuration qualify. Rates, eligible amount bases, recurrence, and exclusions are set by Sure Imports and displayed in the affiliate workspace. Buy from Chinese Websites earns on eligible product cost rather than the total order. Supplier Verification excludes factory-visit transportation costs. A rate change applies to qualifying transactions completed after the change unless we expressly state otherwise.'],
