...
const sections = [
  ...
  ['3. Eligible services and rates', 'Only services shown as active in the programme configuration qualify. Rates, eligible amount bases, recurrence, and exclusions are set by Sure Imports and displayed in the affiliate workspace. Buy from Chinese Websites earns on eligible product cost rather than the total order. Supplier Verification excludes factory-visit transportation costs. Ship with Us commissions use the final verified billable KG or CBM on the linked paid invoice; duties, storage, verification, penalties and unrelated charges are excluded. A rate change applies to qualifying transactions completed after the change unless an invoice has already locked its commission snapshot.'],
...
export default function AffiliateTermsPage() {
  return <main className="affiliate-legal-page">
    ...
    <footer className="site-footer affiliate-legal-footer"><div className="site-container footer-top"><Link className="footer-brand" href="/" aria-label="Sure Imports Affiliate home"><Image src="/images/logo-white.png" width={664} height={106} alt="Sure Imports" /><span>Affiliate</span></Link><div className="footer-links"><Link href="/#how-it-works">How it works</Link><Link href="/#commissions">Commissions</Link><Link href="/#payouts">Payouts</Link><Link href="/affiliate-terms">Affiliate terms</Link><a href="https://www.sureimports.com">Sure Imports</a></div></div><div className="site-container footer-bottom"><span>© {new Date().getFullYear()} Sure Importers Limited</span><span>Recommend responsibly. Earn transparently.</span></div></footer>
  </main>;
}
